...
/**
 * GET /api/mail/filters/recipients?q=... — autocomplétion de destinataires.
 * Même pool que les expéditeurs (participants détectés dans les emails) :
 * GEDify ne distingue pas le sens à ce niveau. Réponse { items: [{ name, email }] }.
 */
export async function GET(req: NextRequest) {
  try {
    ...
    return jsonError("Autocomplétion destinataires impossible", error);
  }
}
