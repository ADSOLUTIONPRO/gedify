...
export const SPACE_MENUS: Record<string, SpaceMenu> = {
  ...
  "gestion-clients": {
    ...
    items: [
      ...
      { label: "Support clients", href: "/admin/saas/support", icon: LifeBuoy, group: "exploitation" },
      ...
      { label: "Chiffrement", href: "/admin/saas/encryption", icon: Lock, group: "exploitation" },
