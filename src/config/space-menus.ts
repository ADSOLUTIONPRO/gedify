...
export const SPACE_MENUS: Record<string, SpaceMenu> = {
  ...
  documents: {
    ...
    items: [
      ...
      { label: "À traiter", href: "/documents?tab=a-traiter", icon: Inbox, group: "docs", subtitle: "À valider ou à compléter" },
  ...
  administration: {
    ...
    items: [
      ...
      { label: "Utilisateurs & accès", href: "/utilisateurs", icon: Users, group: "gouvernance" },
      { label: "Groupes & rôles", href: "/administration/roles", icon: ShieldCheck, group: "gouvernance" },
      { label: "Audit & journaux", href: "/journaux", icon: ScrollText, group: "gouvernance" },
      { label: "Sécurité & conformité", href: "/statut", icon: Lock, group: "gouvernance" },
      // Configuration système
      { label: "Paramètres généraux", href: "/administration/parametres", icon: Settings, group: "configuration" },
      { label: "Stockage & fichiers", href: "/administration/sante", icon: HardDrive, group: "configuration" },
      { label: "Sauvegardes & restauration", href: "/administration/sauvegarde", icon: DatabaseBackup, group: "configuration" },
      { label: "Mises à jour", href: "/administration/mises-a-jour", icon: RefreshCw, group: "configuration" },
      ...
      { label: "Services & connecteurs", href: "/emails", icon: Plug, group: "infrastructure" },
      { label: "Bases de données", href: "/administration/sante", icon: Database, group: "infrastructure" },
      ...
      { label: "Modèles & formats", href: "/administration/modeles-ia", icon: Bot, group: "personnalisation" },
      ...
      { label: "Exports techniques", href: "/administration/sauvegarde", icon: Download, group: "support" },
