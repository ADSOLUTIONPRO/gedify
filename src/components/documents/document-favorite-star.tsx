...
/** Étoile favori (par utilisateur). N'ouvre/ne sélectionne jamais la carte. */
export function DocumentFavoriteStar({ documentId, className }: { documentId: number; className?: string }) {
  ...
  return (
    <button
      ...
      className={className ?? "flex h-7 w-7 items-center justify-center rounded-full bg-white/90 shadow-sm transition hover:bg-white"}
