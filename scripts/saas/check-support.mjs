...
async function main() {
  ...
  try {
    ...
    console.log(`   \u2022 Ouvertes / \xE0 traiter  : ${open} / ${pending}`);
    console.log(`   \u2022 R\xE9solues / cl\xF4tur\xE9es  : ${resolved}`);
    console.log(`   \u2022 Non assign\xE9es         : ${unassigned}`);
    console.log(`   \u2022 Messages (dont notes internes) : ${messages} (${internal})`);
    console.log(`   \u2022 Politiques SLA        : ${sla}`);
    console.log(`   \u2022 R\xE9ponses types        : ${canned}`);
    if (breached > 0) console.log(`   \u26A0\uFE0F  SLA de 1re r\xE9ponse d\xE9pass\xE9 : ${breached}`);
...
main().catch((e) => {
  console.error("\u274C saas:check-support :", e instanceof Error ? e.message : String(e));
  process.exit(1);
});
