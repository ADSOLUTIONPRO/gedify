...
// scripts/saas/check-memberships.ts
async function main() {
  ...
  try {
    ...
    console.log("Adh\xE9sions :");
    console.log(`   \u2022 Tenants sans owner        : ${noOwner}`);
    console.log(`   \u2022 Tenants \xE0 plusieurs owners: ${multiOwner}`);
    ...
    console.log(`   \u2022 R\xF4les invalides           : ${badRole}`);
    ...
    if (staleInv >= 0) console.log(`   \u2022 Invitations expir\xE9es non trait\xE9es : ${staleInv}`);
    if (staleInv > 0) console.log("     \u2192 lancez `npm run saas:expire-invitations`");
    if (problems === 0) console.log("\n\u2705 Adh\xE9sions coh\xE9rentes.");
    else console.log(`
\u274C ${problems} probl\xE8me(s) d\xE9tect\xE9(s).`);
...
main().catch((e) => {
  console.error("\u274C saas:check-memberships :", e instanceof Error ? e.message : String(e));
  process.exit(1);
});
