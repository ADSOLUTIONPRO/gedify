...
async function main() {
  ...
  try {
    ...
    if (trialing < 0) {
      console.log("\u26A0\uFE0F  Table subscriptions absente \u2014 ex\xE9cutez `npm run db:push`.");
      process.exit(0);
    }
    console.log("P\xE9riodes d'essai :");
    ...
    console.log(`   \u2022 Expir\xE9es non trait\xE9es      : ${overdue}`);
...
main().catch((e) => {
  console.error("\u274C saas:check-trials :", e instanceof Error ? e.message : String(e));
  process.exit(1);
});
