...
// scripts/saas/expire-invitations.ts
async function main() {
  ...
  try {
    ...
    console.log(`\u2705 expire-invitations : ${n} invitation(s) expir\xE9e(s).`);
  } finally {
    await client.end();
  }
  process.exit(0);
...
main().catch((e) => {
  console.error("\u274C saas:expire-invitations :", e instanceof Error ? e.message : String(e));
  process.exit(1);
});
