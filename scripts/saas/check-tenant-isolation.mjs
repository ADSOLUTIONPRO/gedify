...
// scripts/saas/check-tenant-isolation.ts
var NULL_TABLES = [
  "documents",
  "tags",
  "correspondents",
...
async function main() {
  ...
  try {
    ...
    if (relVsDoc == null) {
      console.log("   \u2022 relation\u2194document        : (non v\xE9rifiable)");
    } else {
      console.log(`   \u2022 relation\u2194document        : ${relVsDoc} incoh\xE9rence(s)`);
    ...
    if (corrVsRel == null) {
      console.log("   \u2022 correspondant\u2194relation   : (non v\xE9rifiable)");
    } else {
      console.log(`   \u2022 correspondant\u2194relation   : ${corrVsRel} incoh\xE9rence(s)`);
      if (corrVsRel > 0) failures.push(`${corrVsRel} correspondant(s) li\xE9s dans un autre tenant`);
    }
    console.log("\nR\xE9partition par tenant :");
    ...
    if (failures.length === 0) {
      console.log("\u2705 Isolation tenant OK \u2014 aucune fuite ni incoh\xE9rence d\xE9tect\xE9e.");
      process.exit(0);
    } else {
      console.error("\u274C Isolation tenant : anomalies d\xE9tect\xE9es :");
      for (const f of failures) console.error(`   - ${f}`);
      console.error("\u2192 Lancez `npm run saas:attach-data` puis relancez ce contr\xF4le.");
      process.exit(1);
    }
  } finally {
    await client.end();
